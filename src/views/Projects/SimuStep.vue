        ...
        <b-col lg="8">
          <b-row class="top-content">
            ...
            <b-col class="tech hidden"
              ><h3><i class="fa fa-tag"></i>&nbsp;Python</h3></b-col
            >
            <hr />
          </b-row>
          <b-row class="bot-content">
            ...
            <b-col class="hackathon hidden" md="12" lg="6"
              ><h4><i class="fa fa-tag"></i>&nbsp;Capstone Project</h4></b-col
            >
          </b-row>
          <b-row>
            <b-col class="details hidden">
              <p>
                SimuStep is a neuroprosthetic assistive walking device for
                people affected by foot drop. The device provides active
                electrical muscle stimulation to help patients walk by
                themselves and help rehabilitate the condition in the process.
              </p>
            </b-col>
          </b-row>
          <b-row>
